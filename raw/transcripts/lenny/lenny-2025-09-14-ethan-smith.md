---
episode_date: '2025-09-14'
guest: ethan-smith
id: lenny-2025-09-14-ethan-smith
key_insights:
...
**Ethan Smith:** But that's not the case in the LLM, because the LLM is summarizing many citations, and so you need to get mentioned as many times as possible.
...
**Ethan Smith:** You can be mentioned on a blog. So early-stage companies can win, they can win quickly.
...
**Ethan Smith:** Google's slice of the pie stays the same. The pie gets bigger.
...
**Lenny Rachitsky:** Things are changing in the world of SEO. And so I'm excited to talk to you again about how to be successful in this new-emerging world where AI is changing how SEO works, the rise of AEO and GEO.

**Lenny Rachitsky:** Let me start with just this question. How long have you been working on SEO at this point? And has anything come close to being this significant in changing the skill of SEO?
...
**Ethan Smith:** And that was probably the biggest shift, which is Google introduced a bunch of algorithms, Panda and similar things, to prevent you from doing spam. So essentially, you went from the SEO being spam to not spam. That was probably the biggest change, and then this is probably the second-biggest change.

**Ethan Smith:** I think that the main thing here is it is related to search, but it's a summarization of search and there's new inputs. So it's probably the second-biggest change.
...
**Lenny Rachitsky:** We have to rethink everything. You're saying this is actually the second-biggest change, and just like Google's update back in the day was actually even more significant?
...
**Lenny Rachitsky:** There's actually two, AEO and GEO. What do they stand for? Are they different? What are they referring to specifically?
