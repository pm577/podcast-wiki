...
id: lenny-2026-01-11-aishwarya-naresh-reganti-kiriti-badam
key_insights:
- 'Aishwarya Naresh Reganti: Most people tend to ignore the non-determinism. You don''t
  know how the user might behave with your product, and you also don''t know how the
  LLM might respond to that. The second difference is the agen...'
- 'Kiriti Badam: So we recommend building step-by-step. When you start small, it forces
  you to think about what is the problem that I''m going to solve. In all this advancements
...
**Guest:** Aishwarya Naresh Reganti + Kiriti Badam
**Date:** 2026-01-11
**Topics:** leadership, saas, startups, hiring, marketplace, retention, ai-ml
...
**Lenny Rachitsky:** Is there anything else you want to add there before we get into that?
...
**Kiriti Badam:** So that's extremely important. And we see this as a repeating pattern over and over.
...
**Kiriti Badam:** So we recommend building step by step and then increasing it.
